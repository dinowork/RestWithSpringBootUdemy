...
public class DozerConverterTest {
	...
	public void parseEntityListToVOListTest() {
		List<PersonVO> outputList = DozerConverter.parseObject(inputObject.mockEntityList(), PersonVO.class);
	...
	public void parseVOListToEntityListTest() {
		List<Person> outputList = DozerConverter.parseObject(inputObject.mockVOList(), Person.class);
