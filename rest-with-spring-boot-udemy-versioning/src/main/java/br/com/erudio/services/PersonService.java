...
public class PersonService {
	...
	public PersonVO create(PersonVO person) {
		var entity = repository.save(DozerConverter.parseObject(person, Person.class));
		var vo = DozerConverter.parseObject(entity, PersonVO.class);
		return vo;
	}
	
	public PersonVOV2 createV2(PersonVOV2 person) {
		var entity = repository.save(converter.converterVOToEntity(person));
		var vo = converter.converterEntityToVO(entity);
		return vo;	
	}
